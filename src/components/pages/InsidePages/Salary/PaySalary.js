                        ...
                        {this.state.searchResults.map((emp, idx) => (
                            <div key={idx} className='flex p-4'>
                                <Link
                                    key={idx}
                                    to={{
                                        pathname: '/eSkooly/pages/Salary/Pay-Salary/Inside-Pay-Salary',
                                        state: { employeeId: emp.employeeId, name: emp.name, FatherName: emp.fatherName }
                                    }}
                                    onClick={() => {
                                        const stateObject = {
                                        ...
                                        localStorage.setItem('paySalaryState', JSON.stringify(stateObject));
                                    }}
