    ...
    return (
        <div className='flex justify-around sticky top-0 bg-[#fff] w-full py-7 items-center'>
            <div className='flex justify-between ml-[-8rem]'>
                ...
                <button className='mx-4'>GREAT AUBREY MEMORIAL COLLEGE</button>
            ...
            <div className='flex mr-[-8rem] justify-between'>
                ...
                <button className='mx-4 text-[#fff] border-black border hover:bg-[#fff] hover:text-[black] bg-black py-2 px-3 rounded-xl'>GAMCO</button>
            </div>
        </div>
    );
}
